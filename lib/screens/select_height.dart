...
class SelectHeight extends StatefulWidget {
  ...
  SelectHeight({super.key, required this.gender});
...
class _SelectHeightState extends State<SelectHeight> {
  ...
  Widget build(BuildContext context) {
    ...
    isCM
        ? _currentSliderValue = heightProviders.cmSlider
        : _currentSliderValue = heightProviders.feetSlider;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(AppLocalizations.of(context).heightChoose,
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                                ...
                                ScaffoldMessenger.of(context)
                                    .showSnackBar(SnackBar(
                                        ...
                                        content: Container(
                                          ...
                                          child: Text(
                                            isCM
                                                ? AppLocalizations.of(context).snackbarHl
                                                : AppLocalizations.of(context).snackbarFl,
                      ...
                      Text(
                          isCM
                              ? '${_currentSliderValue.toStringAsFixed(1)} ${AppLocalizations.of(context).cm}'
                              : '${_currentSliderValue.toStringAsFixed(1)} ${AppLocalizations.of(context).feet}',
                      ...
                      Card(
                        ...
                        child: IconButton(
                            ...
                            onPressed: () {
                              if (isCM
                                  ? 0 < heightProviders.cmSlider &&
                                      heightProviders.cmSlider < 260
                                  : 0 < heightProviders.feetSlider &&
                                      heightProviders.feetSlider < 10) {
                                isCM
                                    ? heightProviders.increaseCM()
                                    : heightProviders.increaseFeet();
                              } else {
                                ScaffoldMessenger.of(context)
                                    .showSnackBar(SnackBar(
                                        backgroundColor: Colors.white,
                  ...
                  Text(
                      isCM
                          ? '${cmTometer.toStringAsFixed(2)} ${AppLocalizations.of(context).m}'
                          : '${feetTometer.toStringAsFixed(2)} ${AppLocalizations.of(context).m}',
                      style: const TextStyle(
                          fontWeight: FontWeight.bold, fontSize: 20)),
                ],
              ),
